...
**/
let department = prompt("Ingrese un departamento que quiera visitar entre: Cundinamarca, Quindío, Antioquia y Valle");
let purpose = prompt("Ingrese el objeto de su visita entre: turismo, comidas, museos");
if (department === null || department === "") {
    alert("Favor ingrese un departamento entre Cundinamarca, Quindío, Antioquia y Valle")
} 
else if (purpose === null || purpose === "") {
    alert("Favor ingrese el objeto de su visita entre: turismo, comidas, museos")
}
...
else if (purpose !== "turismo" || purpose !== "comidas" || purpose !== "museos"){
    alert("por favor indicar otro objeto de su visita entre: turismo, comidas, museos")
  }
else {
    ...
    {alert("En Cundinamarca puedes visitar el Museo del Florero y el Museo del Oro")  
    }
    else if (department === "quindio" && purpose === "turismo") 
    {alert("En el Quindio puedes visitar el Valle del Cocora y Filamdia")  
    }
    ...
    {alert("En el Quindio puedes visitar La Casa del Museo Musical y el Museo de Arte de Armenia")  
    }
    ...
    {alert("En Antioquia puedes visitar el Museo de Arte Moderno de Medellín y el Museo de Agua") 
    }
    else if (department === "valle" && purpose === "turismo") 
    {alert("En el Valle puedes visitar el Zoológico de Cali y el Monumento a Cristo Rey")  
    }
    else if (department === "valle" && purpose === "comidas") 
    {alert("En el Valle puedes comer Cgolado y Aborrajado")  
    }
    else if (department === "valle" && purpose === "museos") 
    {alert("En el Valle puedes visitar el Museo Aéreo Fénix y el Museo de la Caña") 
